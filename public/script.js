$(document).ready(function(){
  ...
  var aboutfade = function(){
      ...
      var scrollOpa = ((height - scrollTop * 1.1 + aboutTriggerTop) / (height));
  ...
  var contactfade = function(){
      ...
      // if(height>scrollTop){
        var scrollOpa = ((height - scrollTop * 1.1 + contactTriggerTop) / (height));
      // }
      // else{
  ...
  var galleryfade = function(){
      ...
      var scrollOpa = ((height - scrollTop * 1.1 + galleryTriggerTop) / (height));
      $('.gallery-box').css({
          'opacity': scrollOpa
      });
  }
  ...
  //   $('.thanks-email').css("visibility","visible");
  //   return false;
  // });
});